...
b1 = Book.create(
  ...
  description: "A memoir about battlefield experiences in Iraq by the Navy SEALs sniper.",
...
Review.create(
  comment: "[My] favorite book of the year. Chris Kyle's American Sniper is an amazingly detailed account of fighting in Iraq -- a humanizing, brave story that's extremely readable.",
...
Review.create(
  comment: "Revealing . . . I'd recommend this to anyone",
  author: "USA Today",
  book_id: b9.id
)

Review.create(
  comment: "Harris' journey of discovery brought back lessons for all of us about our lives, too.",
  author: "Diane Sawyer",
  book_id: b9.id
)
